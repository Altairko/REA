        ...
        <div class="sl-slider">
            ...
            <div class="sl-slide item1" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                <div class="sl-slide-inner">
                    <div class="container">
                        <img class="pull-right" src="images/sample/slider/img1.jpg" alt="" />
                        <h2>НОВОСТРОЙКИ</h2>
                        <h3 class="gap">Первичный рынок жилой недвижимости – это наличие множества преимуществ для тех, кто желает обзавестись новым жильем!</h3>
                        <a class="btn btn-large btn-transparent" href="#">Узнай больше</a>
                    </div>
                </div>
            </div>
            <!--/Slider Item1-->
            ...
            <div class="sl-slide item2" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
                <div class="sl-slide-inner">
                    <div class="container">
                        <img class="pull-right" src="images/sample/slider/img2.jpg" alt="" />
                        <h2>КОНСАЛТИНГ И АНАЛИТИКА</h2>
                        <h3 class="gap">Постоянный мониторинг первичного и вторичного рынков жилой недвижимости.</h3>
                        <a class="btn btn-large btn-transparent" href="#">Узнай больше</a>
                    </div>
                </div>
            </div>
            ...
            <div class="sl-slide item3" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
                <div class="sl-slide-inner">
                   <div class="container">
                    ...
                    <h3 class="gap">Любые операции на рынке коммерческой недвижимости Москвы - аренда, продажа или покупка - проводим на выгодных для клиента условиях и в сжатые сроки.</h3>
                    <a class="btn btn-large btn-transparent" href="#">Узнай больше</a>
                </div>
            </div>
        </div>
